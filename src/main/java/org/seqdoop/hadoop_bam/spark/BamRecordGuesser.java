...
public class BamRecordGuesser {
  ...
  private final ByteBuffer readNameBuffer =
      ByteBuffer
          .allocate(255)
          .order(ByteOrder.LITTLE_ENDIAN);
  ...
  // Modifies BlockCompressedInputStream#seek to throw EOFException when an attempting to seek past EOF
  ...
  // Duplicate of method in Hadoop IOUtils except it throws EOFException rather than IOException for EOF
