...
import org.seqdoop.hadoop_bam.TestCRAMInputFormatOnHDFS;
...
public class MergerTest {
  ...
  public void testHdfsFiles() throws IOException {
    ...
    new Merger().mergeParts(cluster.getConfiguration(0), hdfsDir.toUri().toString(), hdfsFile3.toUri().toString());

    Assert.assertEquals("contents1contents2", IOUtils.toString(cluster.getFileSystem().open(hdfsFile3)));
  }
